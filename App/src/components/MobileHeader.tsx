    ...
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 4, flexShrink: 0 }}>
        ...
        <button onClick={onOpenFolder} title="Open Folder"
          style={{ background: 'none', border: 'none', cursor: 'shadowide', color: 'var(--text-secondary)', padding: 6, borderRadius: 4 }}>
        ...
        <button onClick={onToggleSidebar} title="Toggle Sidebar"
          style={{ background: 'none', border: 'none', cursor: 'shadowide', color: isSidebarVisible ? 'var(--accent-color)' : 'var(--text-secondary)', padding: 6, borderRadius: 4 }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button onClick={onToggleAgent} title="Toggle AI"
          style={{ background: 'none', border: 'none', cursor: 'shadowide', color: isAgentVisible ? 'var(--accent-color)' : 'var(--text-secondary)', padding: 6, borderRadius: 4 }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
