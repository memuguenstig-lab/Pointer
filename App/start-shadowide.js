...
╔════════════════════════════════════════════════════════════════╗
║          ShadowIDE IDE - Development Start Script                ║
╚════════════════════════════════════════════════════════════════╝

Usage: node start-shadowide.js [options]
...
Examples:
  node start-shadowide.js                    # Normal mode with checks
  node start-shadowide.js --background       # Run in background
  node start-shadowide.js --build            # Build only
  BACKEND_PORT=8000 node start-shadowide.js  # Custom backend port
...
╚════════════════════════════════════════════════════════════════╝
    ...
    if (runInBackground) {
      console.log(chalk.cyan(`
╔════════════════════════════════════════════════════════════════╗
║              ✅ ShadowIDE running in background                  ║
...
╚════════════════════════════════════════════════════════════════╝
    ...
    console.log(chalk.yellow('   • View help: node start-shadowide.js --help\n'));
    process.exit(1);
  }
}
...
// Run the script
main().catch(error => {
  console.error('Error running ShadowIDE:', error);
  process.exit(1);
}); 