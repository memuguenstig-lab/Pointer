      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            Share your experiences, contribute to the project, and help us make ShadowIDE even better.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            {
              title: "Open Source",
              description: "ShadowIDE is open source and community-driven. Your contributions help shape the future of the project.",
              icon: (
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center px-8 py-4 rounded-lg bg-white/5 text-white font-semibold border border-white/10 hover:border-white/20 transition-all duration-300 hover:translate-y-[-3px] hover:shadow-lg"
          >
            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
